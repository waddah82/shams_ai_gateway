...
class ExtractFileContent(BaseTool):
    ...
    def _get_ocr_settings(self) -> Dict[str, Any]:
        """Get OCR backend configuration from Shams AI Gateway Settings."""
        try:
            ...
            try:
                ...
                return {
                    ...
                    "error": (
                        ...
                        "You can increase the timeout in Shams AI Gateway Settings > OCR."
                    ),
                    "ocr_backend": "paddleocr",
                }
                ...
                if "MemoryError" in error_msg or "Cannot allocate memory" in error_msg:
                    return {
                        ...
                        "error": (
                            ...
                            "You can increase the memory limit in Shams AI Gateway Settings > OCR."
                        ),
                        "ocr_backend": "paddleocr",
                    }
                return {
