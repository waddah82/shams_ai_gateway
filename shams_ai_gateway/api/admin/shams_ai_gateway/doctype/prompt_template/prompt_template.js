...
frappe.ui.form.on('Prompt Template', {
    ...
    show_preview: function(frm) {
        ...
        // Render preview
        frappe.call({
            method: 'shams_ai_gateway.shams_ai_gateway.doctype.prompt_template.prompt_template.preview_template',
            args: {
    ...
    show_version_history: function(frm) {
        frappe.call({
            method: 'shams_ai_gateway.shams_ai_gateway.doctype.prompt_template.prompt_template.get_version_history',
...
window.shams_ai_gateway_restore_version = function(prompt_name, version_id) {
    frappe.confirm(
        ...
        function() {
            frappe.call({
                method: 'shams_ai_gateway.shams_ai_gateway.doctype.prompt_template.prompt_template.restore_version',
                args: {
