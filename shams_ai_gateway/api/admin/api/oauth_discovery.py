...
def openid_configuration():
    ...
    # Get MCP configuration from Shams AI Gateway Settings
    mcp_protocol_version = "2025-06-18"
    mcp_transport = "StreamableHTTP"
    try:
        core_settings = frappe.get_single("Shams AI Gateway Settings")
...
def authorization_server_metadata():
    ...
    metadata["service_documentation"] = "https://github.com/buildswithpaul/Shams_AI_Gateway"
