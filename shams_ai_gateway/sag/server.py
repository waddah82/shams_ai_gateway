...
def cleanup_old_logs():
    ...
    Retention period is configured in SAG Settings > Security > Audit Log Retention.
    Defaults to 180 days. Set to 0 to disable automatic cleanup.
    """
    try:
        days_to_keep = frappe.db.get_single_value("SAG Settings", "audit_log_retention_days")
