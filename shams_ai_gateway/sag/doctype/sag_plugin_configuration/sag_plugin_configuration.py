...
class SAGPluginConfiguration(Document):
    ...
    def _clear_caches(self):
        ...
        # Also clear the SAG Settings cache (for backward compatibility)
        frappe.clear_document_cache("SAG Settings", "SAG Settings")
