...
class MCPServer:
    ...
    def _handle_tools_list(self, params: Dict, tool_registry: Optional[Dict] = None) -> Dict:
        ...
        # response. These are authoritative regardless of skill mode; Python
        # and linked-skill descriptions are fallbacks for blank/missing rows.
        ...
        for tool in tool_registry.values():
            ...
            # The DocType value wins even in replace mode. This makes edits in
            # SAG Tool Configuration immediately visible to MCP clients.
