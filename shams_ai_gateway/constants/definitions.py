...
class AnalysisThresholds:
    ...
    @property
    def ARTISAGT_CREATION_PROMPT(self):
...
💡 **ARTISAGT TIP:** For larger analyses (>20 lines output), results will auto-stream to artifacts for unlimited depth."""
...
class SuccessMessages:
    ...
    ARTISAGT_CREATED = "Analysis results formatted for artifact creation"
...
💡 ARTISAGT TIP: For extensive analysis workflows, stream results to artifacts for unlimited depth."""
...
💡 ARTISAGT TIP: Create workspace artifacts for comprehensive analysis without response limits."""
...
💡 ARTISAGT TIP: For complex queries and analysis, use artifacts to build comprehensive reports."""
...
💡 ARTISAGT TIP: Document visualization workflows in artifacts for comprehensive reporting."""
