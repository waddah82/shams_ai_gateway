...
class PluginConfig:
    ...
    PLUGIN_SETTINGS_DOCTYPE = "Shams AI Gateway Settings"
...
class PluginPersistence:
    ...
    This replaces the old JSON-based approach in Shams AI Gateway Settings with
    ...
    def _load_from_legacy_json(self) -> Set[str]:
        """Load from legacy JSON field in Shams AI Gateway Settings."""
        try:
