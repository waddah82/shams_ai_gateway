...
- Frappe v15: Uses Shams AI Gateway Settings (our implementation)
...
def get_oauth_settings(use_cache=True):
    ...
    For v15: Reads from Shams AI Gateway Settings
    ...
    if is_frappe_v16_or_later():
        ...
        # Use Frappe v15 - read from Shams AI Gateway Settings
        try:
            if use_cache:
                settings = frappe.get_cached_doc(
                    "Shams AI Gateway Settings", "Shams AI Gateway Settings", ignore_permissions=True
                )
            else:
                settings = frappe.get_doc("Shams AI Gateway Settings", "Shams AI Gateway Settings")
    ...
    return frappe._dict(
        {
            ...
            "resource_documentation": "https://github.com/buildswithpaul/Shams_AI_Gateway",
            "resource_policy_uri": "",
            "resource_tos_uri": "",
            "scopes_supported": "",
        }
